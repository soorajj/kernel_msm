/*
 *  drivers/cpufreq/cpufreq_sooplus.c
 *
...
static unsigned int skip_sooplus = 0;
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_SOOPLUS
static
#endif
struct cpufreq_governor cpufreq_gov_sooplus = {
       .name                   = "sooplus",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_sooplus);
}
...
static void __exit cpufreq_gov_dbs_exit(void)
{
	...
	cpufreq_unregister_governor(&cpufreq_gov_sooplus);
	for_each_possible_cpu(i) {
		struct cpu_dbs_info_s *this_dbs_info =
...
MODULE_DESCRIPTION("'cpufreq_sooplus' - multiphase dynamic cpufreq governor");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_SOOPLUS
